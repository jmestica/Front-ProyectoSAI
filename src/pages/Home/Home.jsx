    ...
    <TopBar/>
     ...
     <Grid fluid className="menu">
      <Row gutter={16}>
        ...
        <Card img_path={img1} title={'Dar de alta reactivo'} link={'/tracker/crearreactivo'} xl={12}/>
        <Card img_path={img2} title={'Gestionar Reactivo'} link={'/tracker/gestionarreactivo'} xl={12}/>
